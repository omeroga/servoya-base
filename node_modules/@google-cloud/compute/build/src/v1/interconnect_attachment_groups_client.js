 ...
 * `src/v1/interconnect_attachment_groups_client_config.json`.
...
class InterconnectAttachmentGroupsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1.InterconnectAttachmentGroups', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.interconnectAttachmentGroupsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1.InterconnectAttachmentGroups') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1.InterconnectAttachmentGroups, this._opts, this._providedCustomServicePath);
