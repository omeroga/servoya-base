 ...
 * `src/v1/instance_group_manager_resize_requests_client_config.json`.
...
class InstanceGroupManagerResizeRequestsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1.InstanceGroupManagerResizeRequests', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.instanceGroupManagerResizeRequestsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1.InstanceGroupManagerResizeRequests') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1.InstanceGroupManagerResizeRequests, this._opts, this._providedCustomServicePath);
