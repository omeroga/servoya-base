...
export declare class BackendServicesClient {
     ...
     */
    getEffectiveSecurityPolicies(request?: protos.google.cloud.compute.v1.IGetEffectiveSecurityPoliciesBackendServiceRequest, options?: CallOptions): Promise<[
    ...
    getEffectiveSecurityPolicies(request: protos.google.cloud.compute.v1.IGetEffectiveSecurityPoliciesBackendServiceRequest, options: CallOptions, callback: Callback<protos.google.cloud.compute.v1.IGetEffectiveSecurityPoliciesBackendServiceResponse, protos.google.cloud.compute.v1.IGetEffectiveSecurityPoliciesBackendServiceRequest | null | undefined, {} | null | undefined>): void;
    getEffectiveSecurityPolicies(request: protos.google.cloud.compute.v1.IGetEffectiveSecurityPoliciesBackendServiceRequest, callback: Callback<protos.google.cloud.compute.v1.IGetEffectiveSecurityPoliciesBackendServiceResponse, protos.google.cloud.compute.v1.IGetEffectiveSecurityPoliciesBackendServiceRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     */
    testIamPermissions(request?: protos.google.cloud.compute.v1.ITestIamPermissionsBackendServiceRequest, options?: CallOptions): Promise<[
    ...
    *   for more details and examples.
    */
    listUsable(request?: protos.google.cloud.compute.v1.IListUsableBackendServicesRequest, options?: CallOptions): Promise<[
        protos.google.cloud.compute.v1.IBackendService[],
