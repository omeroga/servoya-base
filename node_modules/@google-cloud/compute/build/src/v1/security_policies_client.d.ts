...
export declare class SecurityPoliciesClient {
     ...
     */
    aggregatedListAsync(request?: protos.google.cloud.compute.v1.IAggregatedListSecurityPoliciesRequest, options?: CallOptions): AsyncIterable<[string, protos.google.cloud.compute.v1.ISecurityPoliciesScopedList]>;
    /**
