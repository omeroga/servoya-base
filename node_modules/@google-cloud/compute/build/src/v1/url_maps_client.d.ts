...
export declare class UrlMapsClient {
     ...
     */
    aggregatedListAsync(request?: protos.google.cloud.compute.v1.IAggregatedListUrlMapsRequest, options?: CallOptions): AsyncIterable<[string, protos.google.cloud.compute.v1.IUrlMapsScopedList]>;
    /**
