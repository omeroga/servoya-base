...
export declare class NetworksClient {
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     *   The first element of the array is an object representing {@link protos.google.cloud.compute.v1.Network|Network}.
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     *   The first element of the array is an object representing {@link protos.google.cloud.compute.v1.NetworksGetEffectiveFirewallsResponse|NetworksGetEffectiveFirewallsResponse}.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
     *   for more details and examples.
     ...
     * @param {string} request.network
     *   Name of the network resource to remove peering from.
     * @param {google.cloud.compute.v1.NetworksRequestRemovePeeringRequest} request.networksRequestRemovePeeringRequestResource
     *   The body resource for this request
     * @param {string} request.project
     *   Project ID for this request.
     * @param {string} request.requestId
     ...
     *   and might get backwards-incompatible changes at any time.
     *   `.promise()` is not supported yet.
     * @example <caption>include:samples/generated/v1/networks.request_remove_peering.js</caption>
     * region_tag:compute_v1_generated_Networks_RequestRemovePeering_async
     */
    requestRemovePeering(request?: protos.google.cloud.compute.v1.IRequestRemovePeeringNetworkRequest, options?: CallOptions): Promise<[
        LROperation<protos.google.cloud.compute.v1.IOperation, null>,
        protos.google.cloud.compute.v1.IOperation | undefined,
        {} | undefined
    ]>;
    requestRemovePeering(request: protos.google.cloud.compute.v1.IRequestRemovePeeringNetworkRequest, options: CallOptions, callback: Callback<protos.google.cloud.compute.v1.IOperation, protos.google.cloud.compute.v1.IRequestRemovePeeringNetworkRequest | null | undefined, {} | null | undefined>): void;
    requestRemovePeering(request: protos.google.cloud.compute.v1.IRequestRemovePeeringNetworkRequest, callback: Callback<protos.google.cloud.compute.v1.IOperation, protos.google.cloud.compute.v1.IRequestRemovePeeringNetworkRequest | null | undefined, {} | null | undefined>): void;
    /**
    ...
    *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
    * @returns {Promise} - The promise which resolves to an array.
    *   The first element of the array is Array of {@link protos.google.cloud.compute.v1.Network|Network}.
    ...
    *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
    * @returns {Promise} - The promise which resolves to an array.
    *   The first element of the array is Array of {@link protos.google.cloud.compute.v1.ExchangedPeeringRoute|ExchangedPeeringRoute}.
    *   The client library will perform auto-pagination by default: it will call the API as many
    *   times as needed and will merge results from all the pages into this array.
    *   Note that it can affect your quota.
