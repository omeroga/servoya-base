...
exports.VpnTunnelsClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1/vpn_tunnels_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./vpn_tunnels_client_config.json");
...
class VpnTunnelsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1.VpnTunnels', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.vpnTunnelsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1.VpnTunnels') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1.VpnTunnels, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const vpnTunnelsStubMethods = ['aggregatedList', 'delete', 'get', 'insert', 'list', 'setLabels'];
        for (const methodName of vpnTunnelsStubMethods) {
            const callPromise = this.vpnTunnelsStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=vpn_tunnels_client.js.map