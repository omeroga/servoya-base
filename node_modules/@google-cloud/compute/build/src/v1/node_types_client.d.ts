...
export declare class NodeTypesClient {
     ...
     *   The first element of the array is an object representing {@link protos.google.cloud.compute.v1.NodeType|NodeType}.
     ...
     */
    aggregatedListAsync(request?: protos.google.cloud.compute.v1.IAggregatedListNodeTypesRequest, options?: CallOptions): AsyncIterable<[string, protos.google.cloud.compute.v1.INodeTypesScopedList]>;
    /**
    ...
    *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
    * @returns {Promise} - The promise which resolves to an array.
    *   The first element of the array is Array of {@link protos.google.cloud.compute.v1.NodeType|NodeType}.
