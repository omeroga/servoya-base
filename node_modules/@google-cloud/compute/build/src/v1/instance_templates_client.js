...
class InstanceTemplatesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1.InstanceTemplates', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.instanceTemplatesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1.InstanceTemplates') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1.InstanceTemplates, this._opts, this._providedCustomServicePath);
     ...
     *   as tuple [string, {@link protos.google.cloud.compute.v1.InstanceTemplatesScopedList|InstanceTemplatesScopedList}]. The API will be called under the hood as needed, once per the page,
