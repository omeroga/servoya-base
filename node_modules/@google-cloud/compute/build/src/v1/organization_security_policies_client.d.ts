...
export declare class OrganizationSecurityPoliciesClient {
     ...
     *   and might get backwards-incompatible changes at any time.
     *   `.promise()` is not supported yet.
     * @example <caption>include:samples/generated/v1/organization_security_policies.remove_association.js</caption>
     * region_tag:compute_v1_generated_OrganizationSecurityPolicies_RemoveAssociation_async
     */
     ...
     *   and might get backwards-incompatible changes at any time.
     *   `.promise()` is not supported yet.
     * @example <caption>include:samples/generated/v1/organization_security_policies.remove_rule.js</caption>
     * region_tag:compute_v1_generated_OrganizationSecurityPolicies_RemoveRule_async
     */
