 ...
 * `src/v1/backend_buckets_client_config.json`.
...
class BackendBucketsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1.BackendBuckets', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.backendBucketsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1.BackendBuckets') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1.BackendBuckets, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const backendBucketsStubMethods = ['addSignedUrlKey', 'delete', 'deleteSignedUrlKey', 'get', 'getIamPolicy', 'insert', 'list', 'patch', 'setEdgeSecurityPolicy', 'setIamPolicy', 'testIamPermissions', 'update'];
