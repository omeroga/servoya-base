 ...
 * `src/v1/public_delegated_prefixes_client_config.json`.
...
class PublicDelegatedPrefixesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1.PublicDelegatedPrefixes', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.publicDelegatedPrefixesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1.PublicDelegatedPrefixes') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1.PublicDelegatedPrefixes, this._opts, this._providedCustomServicePath);
