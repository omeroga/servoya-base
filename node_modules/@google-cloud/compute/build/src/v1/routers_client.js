...
class RoutersClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1.Routers', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.routersStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1.Routers') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1.Routers, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const routersStubMethods = ['aggregatedList', 'delete', 'deleteRoutePolicy', 'get', 'getNatIpInfo', 'getNatMappingInfo', 'getRoutePolicy', 'getRouterStatus', 'insert', 'list', 'listBgpRoutes', 'listRoutePolicies', 'patch', 'patchRoutePolicy', 'preview', 'update', 'updateRoutePolicy'];
