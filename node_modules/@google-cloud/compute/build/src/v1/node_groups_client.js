...
exports.NodeGroupsClient = void 0;
 ...
 */
const gapicConfig = require("./node_groups_client_config.json");
...
class NodeGroupsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            ...
            listNodes: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'items')
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1.NodeGroups', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.nodeGroupsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1.NodeGroups') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1.NodeGroups, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const nodeGroupsStubMethods = ['addNodes', 'aggregatedList', 'delete', 'deleteNodes', 'get', 'getIamPolicy', 'insert', 'list', 'listNodes', 'patch', 'performMaintenance', 'setIamPolicy', 'setNodeTemplate', 'simulateMaintenanceEvent', 'testIamPermissions'];
        for (const methodName of nodeGroupsStubMethods) {
            const callPromise = this.nodeGroupsStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    addNodes(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    deleteNodes(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    setNodeTemplate(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
//# sourceMappingURL=node_groups_client.js.map