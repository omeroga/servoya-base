...
class SecurityPoliciesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1.SecurityPolicies', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.securityPoliciesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1.SecurityPolicies') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1.SecurityPolicies, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const securityPoliciesStubMethods = ['addRule', 'aggregatedList', 'delete', 'get', 'getRule', 'insert', 'list', 'listPreconfiguredExpressionSets', 'patch', 'patchRule', 'removeRule', 'setLabels'];
     ...
     *   as tuple [string, {@link protos.google.cloud.compute.v1.SecurityPoliciesScopedList|SecurityPoliciesScopedList}]. The API will be called under the hood as needed, once per the page,
