 ...
 * `src/v1/global_forwarding_rules_client_config.json`.
...
class GlobalForwardingRulesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1.GlobalForwardingRules', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.globalForwardingRulesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1.GlobalForwardingRules') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1.GlobalForwardingRules, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const globalForwardingRulesStubMethods = ['delete', 'get', 'insert', 'list', 'patch', 'setLabels', 'setTarget'];
