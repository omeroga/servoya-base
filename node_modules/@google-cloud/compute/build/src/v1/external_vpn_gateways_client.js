 ...
 * `src/v1/external_vpn_gateways_client_config.json`.
...
class ExternalVpnGatewaysClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1.ExternalVpnGateways', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.externalVpnGatewaysStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1.ExternalVpnGateways') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1.ExternalVpnGateways, this._opts, this._providedCustomServicePath);
