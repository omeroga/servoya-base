...
class UrlMapsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1.UrlMaps', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.urlMapsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1.UrlMaps') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1.UrlMaps, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const urlMapsStubMethods = ['aggregatedList', 'delete', 'get', 'insert', 'invalidateCache', 'list', 'patch', 'update', 'validate'];
     ...
     *   as tuple [string, {@link protos.google.cloud.compute.v1.UrlMapsScopedList|UrlMapsScopedList}]. The API will be called under the hood as needed, once per the page,
