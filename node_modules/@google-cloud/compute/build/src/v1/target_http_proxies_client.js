 ...
 * `src/v1/target_http_proxies_client_config.json`.
...
class TargetHttpProxiesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1.TargetHttpProxies', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.targetHttpProxiesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1.TargetHttpProxies') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1.TargetHttpProxies, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const targetHttpProxiesStubMethods = ['aggregatedList', 'delete', 'get', 'insert', 'list', 'patch', 'setUrlMap'];
