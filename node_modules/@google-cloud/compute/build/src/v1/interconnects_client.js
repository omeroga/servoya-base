...
exports.InterconnectsClient = void 0;
 ...
 */
const gapicConfig = require("./interconnects_client_config.json");
...
class InterconnectsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1.Interconnects', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.interconnectsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1.Interconnects') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1.Interconnects, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const interconnectsStubMethods = ['delete', 'get', 'getDiagnostics', 'getMacsecConfig', 'insert', 'list', 'patch', 'setLabels'];
        for (const methodName of interconnectsStubMethods) {
            const callPromise = this.interconnectsStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getDiagnostics(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    getMacsecConfig(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
//# sourceMappingURL=interconnects_client.js.map