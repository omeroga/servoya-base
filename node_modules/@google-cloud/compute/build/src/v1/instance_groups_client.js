...
exports.InstanceGroupsClient = void 0;
 ...
 */
const gapicConfig = require("./instance_groups_client_config.json");
...
class InstanceGroupsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1.InstanceGroups', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.instanceGroupsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1.InstanceGroups') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1.InstanceGroups, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const instanceGroupsStubMethods = ['addInstances', 'aggregatedList', 'delete', 'get', 'insert', 'list', 'listInstances', 'removeInstances', 'setNamedPorts', 'testIamPermissions'];
        for (const methodName of instanceGroupsStubMethods) {
            const callPromise = this.instanceGroupsStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    addInstances(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    removeInstances(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
//# sourceMappingURL=instance_groups_client.js.map