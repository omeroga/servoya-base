...
export declare class AddressesClient {
     ...
     * @param {string} request.region
     *   Name of the region for this request.
     * @param {google.cloud.compute.v1.RegionAddressesMoveRequest} request.regionAddressesMoveRequestResource
     *   The body resource for this request
     * @param {string} request.requestId
     *   An optional request ID to identify requests. Specify a unique request ID so
     *   that if you must retry your request, the server will know to ignore the
     ...
     *   and might get backwards-incompatible changes at any time.
     *   `.promise()` is not supported yet.
     * @example <caption>include:samples/generated/v1/addresses.move.js</caption>
     * region_tag:compute_v1_generated_Addresses_Move_async
     */
    move(request?: protos.google.cloud.compute.v1.IMoveAddressRequest, options?: CallOptions): Promise<[
        LROperation<protos.google.cloud.compute.v1.IOperation, null>,
        protos.google.cloud.compute.v1.IOperation | undefined,
        {} | undefined
    ]>;
    move(request: protos.google.cloud.compute.v1.IMoveAddressRequest, options: CallOptions, callback: Callback<protos.google.cloud.compute.v1.IOperation, protos.google.cloud.compute.v1.IMoveAddressRequest | null | undefined, {} | null | undefined>): void;
    move(request: protos.google.cloud.compute.v1.IMoveAddressRequest, callback: Callback<protos.google.cloud.compute.v1.IOperation, protos.google.cloud.compute.v1.IMoveAddressRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     *   and might get backwards-incompatible changes at any time.
     *   `.promise()` is not supported yet.
     * @example <caption>include:samples/generated/v1/addresses.set_labels.js</caption>
     * region_tag:compute_v1_generated_Addresses_SetLabels_async
     */
    setLabels(request?: protos.google.cloud.compute.v1.ISetLabelsAddressRequest, options?: CallOptions): Promise<[
        LROperation<protos.google.cloud.compute.v1.IOperation, null>,
        protos.google.cloud.compute.v1.IOperation | undefined,
        {} | undefined
    ]>;
    setLabels(request: protos.google.cloud.compute.v1.ISetLabelsAddressRequest, options: CallOptions, callback: Callback<protos.google.cloud.compute.v1.IOperation, protos.google.cloud.compute.v1.ISetLabelsAddressRequest | null | undefined, {} | null | undefined>): void;
    setLabels(request: protos.google.cloud.compute.v1.ISetLabelsAddressRequest, callback: Callback<protos.google.cloud.compute.v1.IOperation, protos.google.cloud.compute.v1.ISetLabelsAddressRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     */
    testIamPermissions(request?: protos.google.cloud.compute.v1.ITestIamPermissionsAddressRequest, options?: CallOptions): Promise<[
    ...
    testIamPermissions(request: protos.google.cloud.compute.v1.ITestIamPermissionsAddressRequest, options: CallOptions, callback: Callback<protos.google.cloud.compute.v1.ITestPermissionsResponse, protos.google.cloud.compute.v1.ITestIamPermissionsAddressRequest | null | undefined, {} | null | undefined>): void;
    testIamPermissions(request: protos.google.cloud.compute.v1.ITestIamPermissionsAddressRequest, callback: Callback<protos.google.cloud.compute.v1.ITestPermissionsResponse, protos.google.cloud.compute.v1.ITestIamPermissionsAddressRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     */
    aggregatedListAsync(request?: protos.google.cloud.compute.v1.IAggregatedListAddressesRequest, options?: CallOptions): AsyncIterable<[string, protos.google.cloud.compute.v1.IAddressesScopedList]>;
    /**
