...
export declare class TargetHttpsProxiesClient {
     ...
     *   a valid UUID with the exception that zero UUID is not supported
     *   (00000000-0000-0000-0000-000000000000).
     * @param {google.cloud.compute.v1.TargetHttpsProxiesSetCertificateMapRequest} request.targetHttpsProxiesSetCertificateMapRequestResource
     *   The body resource for this request
     * @param {string} request.targetHttpsProxy
     ...
     *   and might get backwards-incompatible changes at any time.
     *   `.promise()` is not supported yet.
     * @example <caption>include:samples/generated/v1/target_https_proxies.set_certificate_map.js</caption>
     * region_tag:compute_v1_generated_TargetHttpsProxies_SetCertificateMap_async
     */
     ...
     */
    aggregatedListAsync(request?: protos.google.cloud.compute.v1.IAggregatedListTargetHttpsProxiesRequest, options?: CallOptions): AsyncIterable<[string, protos.google.cloud.compute.v1.ITargetHttpsProxiesScopedList]>;
    /**
