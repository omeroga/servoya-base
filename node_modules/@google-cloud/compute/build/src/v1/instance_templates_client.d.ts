...
export declare class InstanceTemplatesClient {
     ...
     */
    aggregatedListAsync(request?: protos.google.cloud.compute.v1.IAggregatedListInstanceTemplatesRequest, options?: CallOptions): AsyncIterable<[string, protos.google.cloud.compute.v1.IInstanceTemplatesScopedList]>;
    /**
