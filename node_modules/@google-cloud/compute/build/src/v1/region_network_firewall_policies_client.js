 ...
 * `src/v1/region_network_firewall_policies_client_config.json`.
...
class RegionNetworkFirewallPoliciesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1.RegionNetworkFirewallPolicies', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.regionNetworkFirewallPoliciesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1.RegionNetworkFirewallPolicies') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1.RegionNetworkFirewallPolicies, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const regionNetworkFirewallPoliciesStubMethods = ['addAssociation', 'addRule', 'cloneRules', 'delete', 'get', 'getAssociation', 'getEffectiveFirewalls', 'getIamPolicy', 'getRule', 'insert', 'list', 'patch', 'patchRule', 'removeAssociation', 'removeRule', 'setIamPolicy', 'testIamPermissions'];
