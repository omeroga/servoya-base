 ...
 * `src/v1/network_endpoint_groups_client_config.json`.
...
class NetworkEndpointGroupsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1.NetworkEndpointGroups', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.networkEndpointGroupsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1.NetworkEndpointGroups') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1.NetworkEndpointGroups, this._opts, this._providedCustomServicePath);
     ...
     *   as tuple [string, {@link protos.google.cloud.compute.v1.NetworkEndpointGroupsScopedList|NetworkEndpointGroupsScopedList}]. The API will be called under the hood as needed, once per the page,
