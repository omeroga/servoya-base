...
exports.RegionTargetHttpProxiesClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/region_target_http_proxies_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./region_target_http_proxies_client_config.json");
...
class RegionTargetHttpProxiesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.RegionTargetHttpProxies', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        // google.cloud.compute.v1beta.RegionTargetHttpProxies.
        this.regionTargetHttpProxiesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.RegionTargetHttpProxies') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.RegionTargetHttpProxies, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const regionTargetHttpProxiesStubMethods = ['delete', 'get', 'insert', 'list', 'setUrlMap', 'testIamPermissions'];
        for (const methodName of regionTargetHttpProxiesStubMethods) {
            const callPromise = this.regionTargetHttpProxiesStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    close() {
        if (this.regionTargetHttpProxiesStub && !this._terminated) {
...
//# sourceMappingURL=region_target_http_proxies_client.js.map