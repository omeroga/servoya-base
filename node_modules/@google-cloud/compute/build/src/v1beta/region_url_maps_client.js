...
exports.RegionUrlMapsClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/region_url_maps_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./region_url_maps_client_config.json");
...
class RegionUrlMapsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.RegionUrlMaps', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        // google.cloud.compute.v1beta.RegionUrlMaps.
        this.regionUrlMapsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.RegionUrlMaps') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.RegionUrlMaps, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const regionUrlMapsStubMethods = ['delete', 'get', 'insert', 'invalidateCache', 'list', 'patch', 'testIamPermissions', 'update', 'validate'];
        for (const methodName of regionUrlMapsStubMethods) {
            const callPromise = this.regionUrlMapsStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=region_url_maps_client.js.map