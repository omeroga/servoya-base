...
exports.InterconnectAttachmentGroupsClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/interconnect_attachment_groups_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./interconnect_attachment_groups_client_config.json");
...
class InterconnectAttachmentGroupsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.InterconnectAttachmentGroups', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.interconnectAttachmentGroupsStub) {
            return this.interconnectAttachmentGroupsStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.InterconnectAttachmentGroups.
        this.interconnectAttachmentGroupsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.InterconnectAttachmentGroups') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.InterconnectAttachmentGroups, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const interconnectAttachmentGroupsStubMethods = ['delete', 'get', 'getIamPolicy', 'getOperationalStatus', 'insert', 'list', 'patch', 'setIamPolicy', 'testIamPermissions'];
        for (const methodName of interconnectAttachmentGroupsStubMethods) {
            const callPromise = this.interconnectAttachmentGroupsStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    delete(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] = this._gaxModule.routingHeader.fromParams({
            ...
            'interconnect_attachment_group': request.interconnectAttachmentGroup ?? '',
        });
...
//# sourceMappingURL=interconnect_attachment_groups_client.js.map