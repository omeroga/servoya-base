...
exports.AutoscalersClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/autoscalers_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./autoscalers_client_config.json");
...
class AutoscalersClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.Autoscalers', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.autoscalersStub) {
            return this.autoscalersStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.Autoscalers.
        this.autoscalersStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.Autoscalers') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.Autoscalers, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const autoscalersStubMethods = ['aggregatedList', 'delete', 'get', 'insert', 'list', 'patch', 'testIamPermissions', 'update'];
        for (const methodName of autoscalersStubMethods) {
            const callPromise = this.autoscalersStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=autoscalers_client.js.map