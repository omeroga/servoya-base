...
exports.TargetPoolsClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/target_pools_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./target_pools_client_config.json");
...
class TargetPoolsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.TargetPools', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        // google.cloud.compute.v1beta.TargetPools.
        this.targetPoolsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.TargetPools') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.TargetPools, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const targetPoolsStubMethods = ['addHealthCheck', 'addInstance', 'aggregatedList', 'delete', 'get', 'getHealth', 'insert', 'list', 'removeHealthCheck', 'removeInstance', 'setBackup', 'setSecurityPolicy', 'testIamPermissions'];
        for (const methodName of targetPoolsStubMethods) {
            const callPromise = this.targetPoolsStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    addHealthCheck(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        const wrappedCallback = callback
            ? (error, response, nextRequest, rawResponse) => {
                this._log.info('addHealthCheck response %j', rawResponse);
                callback(error, response, nextRequest, rawResponse); // We verified `callback` above.
            }
            : undefined;
        return this.innerApiCalls.addHealthCheck(request, options, wrappedCallback)
    ...
    addInstance(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        const wrappedCallback = callback
            ? (error, response, nextRequest, rawResponse) => {
                this._log.info('addInstance response %j', rawResponse);
                callback(error, response, nextRequest, rawResponse); // We verified `callback` above.
            }
            : undefined;
        return this.innerApiCalls.addInstance(request, options, wrappedCallback)
            ?.then(([response, operation, rawResponse]) => {
            return [
                { latestResponse: response, done: false, name: response.id, metadata: null, result: {} },
                operation,
    ...
    getHealth(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    removeHealthCheck(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        const wrappedCallback = callback
            ? (error, response, nextRequest, rawResponse) => {
                this._log.info('removeHealthCheck response %j', rawResponse);
                callback(error, response, nextRequest, rawResponse); // We verified `callback` above.
            }
            : undefined;
        return this.innerApiCalls.removeHealthCheck(request, options, wrappedCallback)
            ?.then(([response, operation, rawResponse]) => {
            return [
                { latestResponse: response, done: false, name: response.id, metadata: null, result: {} },
                operation,
    ...
    removeInstance(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        const wrappedCallback = callback
            ? (error, response, nextRequest, rawResponse) => {
                this._log.info('removeInstance response %j', rawResponse);
                callback(error, response, nextRequest, rawResponse); // We verified `callback` above.
            }
            : undefined;
        return this.innerApiCalls.removeInstance(request, options, wrappedCallback)
            ?.then(([response, operation, rawResponse]) => {
            return [
                { latestResponse: response, done: false, name: response.id, metadata: null, result: {} },
                operation,
    ...
    setBackup(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        const wrappedCallback = callback
            ? (error, response, nextRequest, rawResponse) => {
                this._log.info('setBackup response %j', rawResponse);
                callback(error, response, nextRequest, rawResponse); // We verified `callback` above.
            }
            : undefined;
        return this.innerApiCalls.setBackup(request, options, wrappedCallback)
            ?.then(([response, operation, rawResponse]) => {
            return [
                { latestResponse: response, done: false, name: response.id, metadata: null, result: {} },
                operation,
...
//# sourceMappingURL=target_pools_client.js.map