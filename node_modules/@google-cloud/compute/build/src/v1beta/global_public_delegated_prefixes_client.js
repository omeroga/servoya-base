...
exports.GlobalPublicDelegatedPrefixesClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/global_public_delegated_prefixes_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./global_public_delegated_prefixes_client_config.json");
...
class GlobalPublicDelegatedPrefixesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.GlobalPublicDelegatedPrefixes', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        // google.cloud.compute.v1beta.GlobalPublicDelegatedPrefixes.
        this.globalPublicDelegatedPrefixesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.GlobalPublicDelegatedPrefixes') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.GlobalPublicDelegatedPrefixes, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const globalPublicDelegatedPrefixesStubMethods = ['delete', 'get', 'insert', 'list', 'patch'];
        for (const methodName of globalPublicDelegatedPrefixesStubMethods) {
            const callPromise = this.globalPublicDelegatedPrefixesStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=global_public_delegated_prefixes_client.js.map