...
export declare class RegionDisksClient {
     ...
     *   and might get backwards-incompatible changes at any time.
     *   `.promise()` is not supported yet.
     * @example <caption>include:samples/generated/v1beta/region_disks.update.js</caption>
     * region_tag:compute_v1beta_generated_RegionDisks_Update_async
     */
    update(request?: protos.google.cloud.compute.v1beta.IUpdateRegionDiskRequest, options?: CallOptions): Promise<[
        LROperation<protos.google.cloud.compute.v1beta.IOperation, null>,
        protos.google.cloud.compute.v1beta.IOperation | undefined,
        {} | undefined
    ]>;
    ...
    *   for more details and examples.
    */
    list(request?: protos.google.cloud.compute.v1beta.IListRegionDisksRequest, options?: CallOptions): Promise<[
        protos.google.cloud.compute.v1beta.IDisk[],
        protos.google.cloud.compute.v1beta.IListRegionDisksRequest | null,
