...
exports.RoutersClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/routers_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./routers_client_config.json");
...
class RoutersClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            ...
            getNatMappingInfo: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'result'),
            list: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'items'),
            listBgpRoutes: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'result'),
            listRoutePolicies: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'result')
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.Routers', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        // google.cloud.compute.v1beta.Routers.
        this.routersStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.Routers') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.Routers, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const routersStubMethods = ['aggregatedList', 'delete', 'deleteRoutePolicy', 'get', 'getNatIpInfo', 'getNatMappingInfo', 'getRoutePolicy', 'getRouterStatus', 'insert', 'list', 'listBgpRoutes', 'listRoutePolicies', 'patch', 'patchRoutePolicy', 'preview', 'testIamPermissions', 'update', 'updateRoutePolicy'];
        for (const methodName of routersStubMethods) {
            const callPromise = this.routersStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    deleteRoutePolicy(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    getNatIpInfo(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    getRoutePolicy(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    getRouterStatus(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    patchRoutePolicy(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    preview(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    updateRoutePolicy(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   as tuple [string, {@link protos.google.cloud.compute.v1beta.RoutersScopedList|RoutersScopedList}]. The API will be called under the hood as needed, once per the page,
     *   so you can stop the iteration when you don't need more results.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1beta/routers.aggregated_list.js</caption>
     * region_tag:compute_v1beta_generated_Routers_AggregatedList_async
     */
    ...
    getNatMappingInfo(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Stream}
     *   An object stream which emits an object representing {@link protos.google.cloud.compute.v1beta.VmEndpointNatMappings|VmEndpointNatMappings} on 'data' event.
    ...
    getNatMappingInfoStream(request, options) {
        ...
        return this.descriptors.page.getNatMappingInfo.createStream(this.innerApiCalls.getNatMappingInfo, request, callSettings);
    }
    /**
     ...
     *   An iterable Object that allows {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols | async iteration }.
     *   When you iterate the returned iterable, each element will be an object representing
     *   {@link protos.google.cloud.compute.v1beta.VmEndpointNatMappings|VmEndpointNatMappings}. The API will be called under the hood as needed, once per the page,
     *   so you can stop the iteration when you don't need more results.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1beta/routers.get_nat_mapping_info.js</caption>
     * region_tag:compute_v1beta_generated_Routers_GetNatMappingInfo_async
     */
    getNatMappingInfoAsync(request, options) {
        ...
        return this.descriptors.page.getNatMappingInfo.asyncIterate(this.innerApiCalls['getNatMappingInfo'], request, callSettings);
    }
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Stream}
     *   An object stream which emits an object representing {@link protos.google.cloud.compute.v1beta.Router|Router} on 'data' event.
     *   The client library will perform auto-pagination by default: it will call the API as many
     *   times as needed. Note that it can affect your quota.
     ...
     *   An iterable Object that allows {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols | async iteration }.
     *   When you iterate the returned iterable, each element will be an object representing
     *   {@link protos.google.cloud.compute.v1beta.Router|Router}. The API will be called under the hood as needed, once per the page,
     *   so you can stop the iteration when you don't need more results.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1beta/routers.list.js</caption>
     * region_tag:compute_v1beta_generated_Routers_List_async
     */
    ...
    listBgpRoutes(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Stream}
     *   An object stream which emits an object representing {@link protos.google.cloud.compute.v1beta.BgpRoute|BgpRoute} on 'data' event.
     *   The client library will perform auto-pagination by default: it will call the API as many
     *   times as needed. Note that it can affect your quota.
    ...
    listBgpRoutesStream(request, options) {
        ...
        return this.descriptors.page.listBgpRoutes.createStream(this.innerApiCalls.listBgpRoutes, request, callSettings);
    }
    /**
     ...
     *   An iterable Object that allows {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols | async iteration }.
     *   When you iterate the returned iterable, each element will be an object representing
     *   {@link protos.google.cloud.compute.v1beta.BgpRoute|BgpRoute}. The API will be called under the hood as needed, once per the page,
     *   so you can stop the iteration when you don't need more results.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1beta/routers.list_bgp_routes.js</caption>
     * region_tag:compute_v1beta_generated_Routers_ListBgpRoutes_async
     */
    listBgpRoutesAsync(request, options) {
        ...
        return this.descriptors.page.listBgpRoutes.asyncIterate(this.innerApiCalls['listBgpRoutes'], request, callSettings);
    }
    listRoutePolicies(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Stream}
     *   An object stream which emits an object representing {@link protos.google.cloud.compute.v1beta.RoutePolicy|RoutePolicy} on 'data' event.
     *   The client library will perform auto-pagination by default: it will call the API as many
     *   times as needed. Note that it can affect your quota.
    ...
    listRoutePoliciesStream(request, options) {
        ...
        return this.descriptors.page.listRoutePolicies.createStream(this.innerApiCalls.listRoutePolicies, request, callSettings);
    }
    /**
     ...
     *   An iterable Object that allows {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols | async iteration }.
     *   When you iterate the returned iterable, each element will be an object representing
     *   {@link protos.google.cloud.compute.v1beta.RoutePolicy|RoutePolicy}. The API will be called under the hood as needed, once per the page,
     *   so you can stop the iteration when you don't need more results.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1beta/routers.list_route_policies.js</caption>
     * region_tag:compute_v1beta_generated_Routers_ListRoutePolicies_async
     */
    listRoutePoliciesAsync(request, options) {
        ...
        return this.descriptors.page.listRoutePolicies.asyncIterate(this.innerApiCalls['listRoutePolicies'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=routers_client.js.map