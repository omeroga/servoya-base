...
exports.GlobalVmExtensionPoliciesClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/global_vm_extension_policies_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./global_vm_extension_policies_client_config.json");
...
class GlobalVmExtensionPoliciesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.GlobalVmExtensionPolicies', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.globalVmExtensionPoliciesStub) {
            return this.globalVmExtensionPoliciesStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.GlobalVmExtensionPolicies.
        this.globalVmExtensionPoliciesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.GlobalVmExtensionPolicies') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.GlobalVmExtensionPolicies, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const globalVmExtensionPoliciesStubMethods = ['aggregatedList', 'delete', 'get', 'insert', 'list', 'update'];
        for (const methodName of globalVmExtensionPoliciesStubMethods) {
            const callPromise = this.globalVmExtensionPoliciesStub.then(stub => (...args) => {
                if (this._terminated) {
...
exports.GlobalVmExtensionPoliciesClient = GlobalVmExtensionPoliciesClient;
//# sourceMappingURL=global_vm_extension_policies_client.js.map