...
exports.InterconnectAttachmentsClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/interconnect_attachments_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./interconnect_attachments_client_config.json");
...
class InterconnectAttachmentsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.InterconnectAttachments', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        // google.cloud.compute.v1beta.InterconnectAttachments.
        this.interconnectAttachmentsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.InterconnectAttachments') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.InterconnectAttachments, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const interconnectAttachmentsStubMethods = ['aggregatedList', 'delete', 'get', 'insert', 'list', 'patch', 'setLabels', 'testIamPermissions'];
        for (const methodName of interconnectAttachmentsStubMethods) {
            const callPromise = this.interconnectAttachmentsStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=interconnect_attachments_client.js.map