...
exports.ReservationBlocksClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/reservation_blocks_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./reservation_blocks_client_config.json");
...
class ReservationBlocksClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.ReservationBlocks', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.reservationBlocksStub) {
            return this.reservationBlocksStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.ReservationBlocks.
        this.reservationBlocksStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.ReservationBlocks') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.ReservationBlocks, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const reservationBlocksStubMethods = ['get', 'getIamPolicy', 'list', 'performMaintenance', 'setIamPolicy', 'testIamPermissions'];
        for (const methodName of reservationBlocksStubMethods) {
            const callPromise = this.reservationBlocksStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    get(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] = this._gaxModule.routingHeader.fromParams({
            ...
            'reservation_block': request.reservationBlock ?? '',
        });
     ...
     */
    close() {
        if (this.reservationBlocksStub && !this._terminated) {
            return this.reservationBlocksStub.then(stub => {
...
//# sourceMappingURL=reservation_blocks_client.js.map