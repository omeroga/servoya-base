...
exports.InstanceGroupManagerResizeRequestsClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/instance_group_manager_resize_requests_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./instance_group_manager_resize_requests_client_config.json");
...
class InstanceGroupManagerResizeRequestsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.InstanceGroupManagerResizeRequests', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.instanceGroupManagerResizeRequestsStub) {
            return this.instanceGroupManagerResizeRequestsStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.InstanceGroupManagerResizeRequests.
        this.instanceGroupManagerResizeRequestsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.InstanceGroupManagerResizeRequests') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.InstanceGroupManagerResizeRequests, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const instanceGroupManagerResizeRequestsStubMethods = ['cancel', 'delete', 'get', 'insert', 'list'];
        for (const methodName of instanceGroupManagerResizeRequestsStubMethods) {
            const callPromise = this.instanceGroupManagerResizeRequestsStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=instance_group_manager_resize_requests_client.js.map