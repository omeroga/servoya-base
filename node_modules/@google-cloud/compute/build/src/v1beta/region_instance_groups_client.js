...
exports.RegionInstanceGroupsClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/region_instance_groups_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./region_instance_groups_client_config.json");
...
class RegionInstanceGroupsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            ...
            listInstances: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'items')
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.RegionInstanceGroups', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        // google.cloud.compute.v1beta.RegionInstanceGroups.
        this.regionInstanceGroupsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.RegionInstanceGroups') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.RegionInstanceGroups, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const regionInstanceGroupsStubMethods = ['get', 'list', 'listInstances', 'setNamedPorts', 'testIamPermissions'];
        for (const methodName of regionInstanceGroupsStubMethods) {
            const callPromise = this.regionInstanceGroupsStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    setNamedPorts(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
//# sourceMappingURL=region_instance_groups_client.js.map