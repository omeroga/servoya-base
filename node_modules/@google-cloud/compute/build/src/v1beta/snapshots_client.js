 ...
 * `src/v1beta/snapshots_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./snapshots_client_config.json");
...
class SnapshotsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.Snapshots', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.snapshotsStub) {
            return this.snapshotsStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.Snapshots.
        this.snapshotsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.Snapshots') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.Snapshots, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const snapshotsStubMethods = ['aggregatedList', 'delete', 'get', 'getIamPolicy', 'insert', 'list', 'setIamPolicy', 'setLabels', 'testIamPermissions'];
        for (const methodName of snapshotsStubMethods) {
            const callPromise = this.snapshotsStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=snapshots_client.js.map