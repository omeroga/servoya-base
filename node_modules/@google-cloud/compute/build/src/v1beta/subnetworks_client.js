...
exports.SubnetworksClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/subnetworks_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./subnetworks_client_config.json");
...
class SubnetworksClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            ...
            listUsable: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'items')
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.Subnetworks', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        // google.cloud.compute.v1beta.Subnetworks.
        this.subnetworksStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.Subnetworks') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.Subnetworks, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const subnetworksStubMethods = ['aggregatedList', 'delete', 'expandIpCidrRange', 'get', 'getIamPolicy', 'insert', 'list', 'listUsable', 'patch', 'setIamPolicy', 'setPrivateIpGoogleAccess', 'testIamPermissions'];
        for (const methodName of subnetworksStubMethods) {
            const callPromise = this.subnetworksStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    expandIpCidrRange(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize().catch(err => { throw err; });
        this._log.info('expandIpCidrRange request %j', request);
        const wrappedCallback = callback
            ? (error, response, nextRequest, rawResponse) => {
                this._log.info('expandIpCidrRange response %j', rawResponse);
                callback(error, response, nextRequest, rawResponse); // We verified `callback` above.
            }
            : undefined;
        return this.innerApiCalls.expandIpCidrRange(request, options, wrappedCallback)
            ?.then(([response, operation, rawResponse]) => {
            return [
                { latestResponse: response, done: false, name: response.id, metadata: null, result: {} },
                operation,
    ...
    setPrivateIpGoogleAccess(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize().catch(err => { throw err; });
        this._log.info('setPrivateIpGoogleAccess request %j', request);
        const wrappedCallback = callback
            ? (error, response, nextRequest, rawResponse) => {
                this._log.info('setPrivateIpGoogleAccess response %j', rawResponse);
                callback(error, response, nextRequest, rawResponse); // We verified `callback` above.
            }
            : undefined;
        return this.innerApiCalls.setPrivateIpGoogleAccess(request, options, wrappedCallback)
            ?.then(([response, operation, rawResponse]) => {
            return [
                { latestResponse: response, done: false, name: response.id, metadata: null, result: {} },
                operation,
    ...
    listUsable(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listUsableStream(request, options) {
        ...
        return this.descriptors.page.listUsable.createStream(this.innerApiCalls.listUsable, request, callSettings);
    }
    /**
    ...
    listUsableAsync(request, options) {
        ...
        return this.descriptors.page.listUsable.asyncIterate(this.innerApiCalls['listUsable'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=subnetworks_client.js.map