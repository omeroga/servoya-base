...
exports.ExternalVpnGatewaysClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/external_vpn_gateways_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./external_vpn_gateways_client_config.json");
...
class ExternalVpnGatewaysClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.ExternalVpnGateways', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.externalVpnGatewaysStub) {
            return this.externalVpnGatewaysStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.ExternalVpnGateways.
        this.externalVpnGatewaysStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.ExternalVpnGateways') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.ExternalVpnGateways, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const externalVpnGatewaysStubMethods = ['delete', 'get', 'insert', 'list', 'setLabels', 'testIamPermissions'];
        for (const methodName of externalVpnGatewaysStubMethods) {
            const callPromise = this.externalVpnGatewaysStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    close() {
        if (this.externalVpnGatewaysStub && !this._terminated) {
            return this.externalVpnGatewaysStub.then(stub => {
...
//# sourceMappingURL=external_vpn_gateways_client.js.map