...
exports.TargetInstancesClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/target_instances_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./target_instances_client_config.json");
...
class TargetInstancesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.TargetInstances', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        // google.cloud.compute.v1beta.TargetInstances.
        this.targetInstancesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.TargetInstances') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.TargetInstances, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const targetInstancesStubMethods = ['aggregatedList', 'delete', 'get', 'insert', 'list', 'setSecurityPolicy', 'testIamPermissions'];
        for (const methodName of targetInstancesStubMethods) {
            const callPromise = this.targetInstancesStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=target_instances_client.js.map