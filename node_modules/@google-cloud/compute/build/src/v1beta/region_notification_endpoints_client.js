...
exports.RegionNotificationEndpointsClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/region_notification_endpoints_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./region_notification_endpoints_client_config.json");
...
class RegionNotificationEndpointsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.RegionNotificationEndpoints', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.regionNotificationEndpointsStub) {
            return this.regionNotificationEndpointsStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.RegionNotificationEndpoints.
        this.regionNotificationEndpointsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.RegionNotificationEndpoints') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.RegionNotificationEndpoints, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const regionNotificationEndpointsStubMethods = ['delete', 'get', 'insert', 'list', 'testIamPermissions'];
        for (const methodName of regionNotificationEndpointsStubMethods) {
            const callPromise = this.regionNotificationEndpointsStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=region_notification_endpoints_client.js.map