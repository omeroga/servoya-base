...
exports.RegionDisksClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/region_disks_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./region_disks_client_config.json");
...
class RegionDisksClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.RegionDisks', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.regionDisksStub) {
            return this.regionDisksStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.RegionDisks.
        this.regionDisksStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.RegionDisks') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.RegionDisks, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const regionDisksStubMethods = ['addResourcePolicies', 'bulkInsert', 'createSnapshot', 'delete', 'get', 'getIamPolicy', 'insert', 'list', 'removeResourcePolicies', 'resize', 'setIamPolicy', 'setLabels', 'startAsyncReplication', 'stopAsyncReplication', 'stopGroupAsyncReplication', 'testIamPermissions', 'update'];
        for (const methodName of regionDisksStubMethods) {
            const callPromise = this.regionDisksStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1beta/region_disks.list.js</caption>
     * region_tag:compute_v1beta_generated_RegionDisks_List_async
     */
...
//# sourceMappingURL=region_disks_client.js.map