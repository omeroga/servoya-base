...
exports.BackendServicesClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/backend_services_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./backend_services_client_config.json");
...
class BackendServicesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.BackendServices', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        // google.cloud.compute.v1beta.BackendServices.
        this.backendServicesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.BackendServices') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.BackendServices, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const backendServicesStubMethods = ['addSignedUrlKey', 'aggregatedList', 'delete', 'deleteSignedUrlKey', 'get', 'getEffectiveSecurityPolicies', 'getHealth', 'getIamPolicy', 'insert', 'list', 'listUsable', 'patch', 'setEdgeSecurityPolicy', 'setIamPolicy', 'setSecurityPolicy', 'testIamPermissions', 'update'];
        for (const methodName of backendServicesStubMethods) {
            const callPromise = this.backendServicesStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getEffectiveSecurityPolicies(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
//# sourceMappingURL=backend_services_client.js.map