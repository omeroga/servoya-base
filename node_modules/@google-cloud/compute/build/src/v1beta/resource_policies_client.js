...
exports.ResourcePoliciesClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/resource_policies_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./resource_policies_client_config.json");
...
class ResourcePoliciesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.ResourcePolicies', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.resourcePoliciesStub) {
            return this.resourcePoliciesStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.ResourcePolicies.
        this.resourcePoliciesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.ResourcePolicies') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.ResourcePolicies, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const resourcePoliciesStubMethods = ['aggregatedList', 'delete', 'get', 'getIamPolicy', 'insert', 'list', 'patch', 'setIamPolicy', 'testIamPermissions'];
        for (const methodName of resourcePoliciesStubMethods) {
            const callPromise = this.resourcePoliciesStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=resource_policies_client.js.map