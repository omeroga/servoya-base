...
exports.TargetHttpProxiesClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/target_http_proxies_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./target_http_proxies_client_config.json");
...
class TargetHttpProxiesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.TargetHttpProxies', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.targetHttpProxiesStub) {
            return this.targetHttpProxiesStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.TargetHttpProxies.
        this.targetHttpProxiesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.TargetHttpProxies') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.TargetHttpProxies, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const targetHttpProxiesStubMethods = ['aggregatedList', 'delete', 'get', 'insert', 'list', 'patch', 'setUrlMap', 'testIamPermissions'];
        for (const methodName of targetHttpProxiesStubMethods) {
            const callPromise = this.targetHttpProxiesStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=target_http_proxies_client.js.map