...
exports.HealthChecksClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/health_checks_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./health_checks_client_config.json");
...
class HealthChecksClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.HealthChecks', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.healthChecksStub) {
            return this.healthChecksStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.HealthChecks.
        this.healthChecksStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.HealthChecks') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.HealthChecks, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const healthChecksStubMethods = ['aggregatedList', 'delete', 'get', 'insert', 'list', 'patch', 'testIamPermissions', 'update'];
        for (const methodName of healthChecksStubMethods) {
            const callPromise = this.healthChecksStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=health_checks_client.js.map