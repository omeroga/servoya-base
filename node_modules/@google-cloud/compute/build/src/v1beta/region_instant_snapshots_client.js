...
exports.RegionInstantSnapshotsClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/region_instant_snapshots_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./region_instant_snapshots_client_config.json");
...
class RegionInstantSnapshotsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.RegionInstantSnapshots', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.regionInstantSnapshotsStub) {
            return this.regionInstantSnapshotsStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.RegionInstantSnapshots.
        this.regionInstantSnapshotsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.RegionInstantSnapshots') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.RegionInstantSnapshots, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const regionInstantSnapshotsStubMethods = ['delete', 'get', 'getIamPolicy', 'insert', 'list', 'setIamPolicy', 'setLabels', 'testIamPermissions'];
        for (const methodName of regionInstantSnapshotsStubMethods) {
            const callPromise = this.regionInstantSnapshotsStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    close() {
        if (this.regionInstantSnapshotsStub && !this._terminated) {
            return this.regionInstantSnapshotsStub.then(stub => {
...
//# sourceMappingURL=region_instant_snapshots_client.js.map