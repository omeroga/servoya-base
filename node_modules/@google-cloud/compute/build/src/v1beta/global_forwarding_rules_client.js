...
exports.GlobalForwardingRulesClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/global_forwarding_rules_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./global_forwarding_rules_client_config.json");
...
class GlobalForwardingRulesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.GlobalForwardingRules', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.globalForwardingRulesStub) {
            return this.globalForwardingRulesStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.GlobalForwardingRules.
        this.globalForwardingRulesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.GlobalForwardingRules') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.GlobalForwardingRules, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const globalForwardingRulesStubMethods = ['delete', 'get', 'insert', 'list', 'patch', 'setLabels', 'setTarget', 'testIamPermissions'];
        for (const methodName of globalForwardingRulesStubMethods) {
            const callPromise = this.globalForwardingRulesStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    close() {
        if (this.globalForwardingRulesStub && !this._terminated) {
            return this.globalForwardingRulesStub.then(stub => {
...
//# sourceMappingURL=global_forwarding_rules_client.js.map