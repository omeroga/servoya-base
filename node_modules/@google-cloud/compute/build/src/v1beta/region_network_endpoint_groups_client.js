...
exports.RegionNetworkEndpointGroupsClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/region_network_endpoint_groups_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./region_network_endpoint_groups_client_config.json");
...
class RegionNetworkEndpointGroupsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.RegionNetworkEndpointGroups', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.regionNetworkEndpointGroupsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.RegionNetworkEndpointGroups') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.RegionNetworkEndpointGroups, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const regionNetworkEndpointGroupsStubMethods = ['attachNetworkEndpoints', 'delete', 'detachNetworkEndpoints', 'get', 'insert', 'list', 'listNetworkEndpoints'];
        for (const methodName of regionNetworkEndpointGroupsStubMethods) {
            const callPromise = this.regionNetworkEndpointGroupsStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=region_network_endpoint_groups_client.js.map