 ...
 * `src/v1beta/interconnects_client_config.json`.
...
class InterconnectsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.Interconnects', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.interconnectsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.Interconnects') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.Interconnects, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const interconnectsStubMethods = ['delete', 'get', 'getDiagnostics', 'getMacsecConfig', 'insert', 'list', 'patch', 'setLabels', 'testIamPermissions'];
