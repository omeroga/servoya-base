...
exports.RegionSnapshotsClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/region_snapshots_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./region_snapshots_client_config.json");
...
class RegionSnapshotsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.RegionSnapshots', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.regionSnapshotsStub) {
            return this.regionSnapshotsStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.RegionSnapshots.
        this.regionSnapshotsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.RegionSnapshots') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.RegionSnapshots, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const regionSnapshotsStubMethods = ['delete', 'get', 'getIamPolicy', 'insert', 'list', 'setIamPolicy', 'setLabels', 'testIamPermissions'];
        for (const methodName of regionSnapshotsStubMethods) {
            const callPromise = this.regionSnapshotsStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    close() {
        if (this.regionSnapshotsStub && !this._terminated) {
            return this.regionSnapshotsStub.then(stub => {
...
exports.RegionSnapshotsClient = RegionSnapshotsClient;
//# sourceMappingURL=region_snapshots_client.js.map