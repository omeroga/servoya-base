...
exports.RegionHealthSourcesClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/region_health_sources_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./region_health_sources_client_config.json");
...
class RegionHealthSourcesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.RegionHealthSources', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.regionHealthSourcesStub) {
            return this.regionHealthSourcesStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.RegionHealthSources.
        this.regionHealthSourcesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.RegionHealthSources') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.RegionHealthSources, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const regionHealthSourcesStubMethods = ['aggregatedList', 'delete', 'get', 'insert', 'list', 'patch', 'testIamPermissions'];
        for (const methodName of regionHealthSourcesStubMethods) {
            const callPromise = this.regionHealthSourcesStub.then(stub => (...args) => {
                if (this._terminated) {
...
exports.RegionHealthSourcesClient = RegionHealthSourcesClient;
//# sourceMappingURL=region_health_sources_client.js.map