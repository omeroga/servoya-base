 ...
 * `src/v1beta/target_https_proxies_client_config.json`.
...
class TargetHttpsProxiesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.TargetHttpsProxies', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        // google.cloud.compute.v1beta.TargetHttpsProxies.
        this.targetHttpsProxiesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.TargetHttpsProxies') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.TargetHttpsProxies, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const targetHttpsProxiesStubMethods = ['aggregatedList', 'delete', 'get', 'insert', 'list', 'patch', 'setCertificateMap', 'setQuicOverride', 'setSslCertificates', 'setSslPolicy', 'setUrlMap', 'testIamPermissions'];
