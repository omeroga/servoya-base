 ...
 * `src/v1beta/addresses_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./addresses_client_config.json");
...
class AddressesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.Addresses', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.addressesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.Addresses') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.Addresses, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const addressesStubMethods = ['aggregatedList', 'delete', 'get', 'insert', 'list', 'move', 'setLabels', 'testIamPermissions'];
        for (const methodName of addressesStubMethods) {
            const callPromise = this.addressesStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    close() {
        if (this.addressesStub && !this._terminated) {
...
//# sourceMappingURL=addresses_client.js.map