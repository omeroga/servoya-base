...
exports.NetworkAttachmentsClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/network_attachments_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./network_attachments_client_config.json");
...
class NetworkAttachmentsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.NetworkAttachments', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.networkAttachmentsStub) {
            return this.networkAttachmentsStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.NetworkAttachments.
        this.networkAttachmentsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.NetworkAttachments') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.NetworkAttachments, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const networkAttachmentsStubMethods = ['aggregatedList', 'delete', 'get', 'getIamPolicy', 'insert', 'list', 'patch', 'setIamPolicy', 'testIamPermissions'];
        for (const methodName of networkAttachmentsStubMethods) {
            const callPromise = this.networkAttachmentsStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    delete(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] = this._gaxModule.routingHeader.fromParams({
            ...
            'network_attachment': request.networkAttachment ?? '',
        });
     ...
     */
    close() {
        if (this.networkAttachmentsStub && !this._terminated) {
            return this.networkAttachmentsStub.then(stub => {
...
//# sourceMappingURL=network_attachments_client.js.map