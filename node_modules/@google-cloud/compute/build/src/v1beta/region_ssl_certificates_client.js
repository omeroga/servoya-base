...
exports.RegionSslCertificatesClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/region_ssl_certificates_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./region_ssl_certificates_client_config.json");
 ...
 * @memberof v1beta
 */
class RegionSslCertificatesClient {
    _terminated = false;
    _opts;
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.RegionSslCertificates', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.regionSslCertificatesStub) {
            return this.regionSslCertificatesStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.RegionSslCertificates.
        this.regionSslCertificatesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.RegionSslCertificates') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.RegionSslCertificates, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const regionSslCertificatesStubMethods = ['delete', 'get', 'insert', 'list', 'testIamPermissions'];
        for (const methodName of regionSslCertificatesStubMethods) {
            const callPromise = this.regionSslCertificatesStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=region_ssl_certificates_client.js.map