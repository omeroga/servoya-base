 ...
 * `src/v1beta/region_target_https_proxies_client_config.json`.
...
class RegionTargetHttpsProxiesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.RegionTargetHttpsProxies', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        // google.cloud.compute.v1beta.RegionTargetHttpsProxies.
        this.regionTargetHttpsProxiesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.RegionTargetHttpsProxies') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.RegionTargetHttpsProxies, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const regionTargetHttpsProxiesStubMethods = ['delete', 'get', 'insert', 'list', 'patch', 'setSslCertificates', 'setUrlMap', 'testIamPermissions'];
