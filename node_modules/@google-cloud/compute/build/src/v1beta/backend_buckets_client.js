...
exports.BackendBucketsClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/backend_buckets_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./backend_buckets_client_config.json");
...
class BackendBucketsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.BackendBuckets', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.backendBucketsStub) {
            return this.backendBucketsStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.BackendBuckets.
        this.backendBucketsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.BackendBuckets') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.BackendBuckets, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const backendBucketsStubMethods = ['addSignedUrlKey', 'aggregatedList', 'delete', 'deleteSignedUrlKey', 'get', 'getIamPolicy', 'insert', 'list', 'listUsable', 'patch', 'setEdgeSecurityPolicy', 'setIamPolicy', 'testIamPermissions', 'update'];
        for (const methodName of backendBucketsStubMethods) {
            const callPromise = this.backendBucketsStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    addSignedUrlKey(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    deleteSignedUrlKey(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    setEdgeSecurityPolicy(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    close() {
        if (this.backendBucketsStub && !this._terminated) {
            return this.backendBucketsStub.then(stub => {
...
//# sourceMappingURL=backend_buckets_client.js.map