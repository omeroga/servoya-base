 ...
 * `src/v1beta/networks_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./networks_client_config.json");
...
class NetworksClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            ...
            listPeeringRoutes: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'items')
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.Networks', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.networksStub) {
            return this.networksStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.Networks.
        this.networksStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.Networks') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.Networks, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const networksStubMethods = ['addPeering', 'delete', 'get', 'getEffectiveFirewalls', 'insert', 'list', 'listPeeringRoutes', 'patch', 'removePeering', 'requestRemovePeering', 'switchToCustomMode', 'testIamPermissions', 'updatePeering'];
        for (const methodName of networksStubMethods) {
            const callPromise = this.networksStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    addPeering(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        const wrappedCallback = callback
            ? (error, response, nextRequest, rawResponse) => {
                this._log.info('addPeering response %j', rawResponse);
                callback(error, response, nextRequest, rawResponse); // We verified `callback` above.
            }
            : undefined;
        return this.innerApiCalls.addPeering(request, options, wrappedCallback)
    ...
    removePeering(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        const wrappedCallback = callback
            ? (error, response, nextRequest, rawResponse) => {
                this._log.info('removePeering response %j', rawResponse);
                callback(error, response, nextRequest, rawResponse); // We verified `callback` above.
            }
            : undefined;
        return this.innerApiCalls.removePeering(request, options, wrappedCallback)
            ?.then(([response, operation, rawResponse]) => {
            return [
                { latestResponse: response, done: false, name: response.id, metadata: null, result: {} },
                operation,
    ...
    requestRemovePeering(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize().catch(err => { throw err; });
        this._log.info('requestRemovePeering request %j', request);
        const wrappedCallback = callback
            ? (error, response, nextRequest, rawResponse) => {
                this._log.info('requestRemovePeering response %j', rawResponse);
                callback(error, response, nextRequest, rawResponse); // We verified `callback` above.
            }
            : undefined;
        return this.innerApiCalls.requestRemovePeering(request, options, wrappedCallback)
            ?.then(([response, operation, rawResponse]) => {
            return [
                { latestResponse: response, done: false, name: response.id, metadata: null, result: {} },
                operation,
    ...
    switchToCustomMode(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        const wrappedCallback = callback
            ? (error, response, nextRequest, rawResponse) => {
                this._log.info('switchToCustomMode response %j', rawResponse);
                callback(error, response, nextRequest, rawResponse); // We verified `callback` above.
            }
            : undefined;
        return this.innerApiCalls.switchToCustomMode(request, options, wrappedCallback)
            ?.then(([response, operation, rawResponse]) => {
            return [
                { latestResponse: response, done: false, name: response.id, metadata: null, result: {} },
                operation,
    ...
    updatePeering(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        const wrappedCallback = callback
            ? (error, response, nextRequest, rawResponse) => {
                this._log.info('updatePeering response %j', rawResponse);
                callback(error, response, nextRequest, rawResponse); // We verified `callback` above.
            }
            : undefined;
        return this.innerApiCalls.updatePeering(request, options, wrappedCallback)
            ?.then(([response, operation, rawResponse]) => {
            return [
                { latestResponse: response, done: false, name: response.id, metadata: null, result: {} },
                operation,
    ...
    listPeeringRoutes(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listPeeringRoutesStream(request, options) {
        ...
        return this.descriptors.page.listPeeringRoutes.createStream(this.innerApiCalls.listPeeringRoutes, request, callSettings);
    }
    /**
    ...
    listPeeringRoutesAsync(request, options) {
        ...
        return this.descriptors.page.listPeeringRoutes.asyncIterate(this.innerApiCalls['listPeeringRoutes'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=networks_client.js.map