...
exports.GlobalNetworkEndpointGroupsClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/global_network_endpoint_groups_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./global_network_endpoint_groups_client_config.json");
...
class GlobalNetworkEndpointGroupsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.GlobalNetworkEndpointGroups', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.globalNetworkEndpointGroupsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.GlobalNetworkEndpointGroups') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.GlobalNetworkEndpointGroups, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const globalNetworkEndpointGroupsStubMethods = ['attachNetworkEndpoints', 'delete', 'detachNetworkEndpoints', 'get', 'insert', 'list', 'listNetworkEndpoints'];
        for (const methodName of globalNetworkEndpointGroupsStubMethods) {
            const callPromise = this.globalNetworkEndpointGroupsStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=global_network_endpoint_groups_client.js.map