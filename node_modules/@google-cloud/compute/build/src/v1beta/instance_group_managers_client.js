...
exports.InstanceGroupManagersClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/instance_group_managers_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./instance_group_managers_client_config.json");
...
class InstanceGroupManagersClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.InstanceGroupManagers', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.instanceGroupManagersStub) {
            return this.instanceGroupManagersStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.InstanceGroupManagers.
        this.instanceGroupManagersStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.InstanceGroupManagers') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.InstanceGroupManagers, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of instanceGroupManagersStubMethods) {
            const callPromise = this.instanceGroupManagersStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getAvailableAcceleratorTopologies(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('getAvailableAcceleratorTopologies response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.getAvailableAcceleratorTopologies(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('getAvailableAcceleratorTopologies response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
...
//# sourceMappingURL=instance_group_managers_client.js.map