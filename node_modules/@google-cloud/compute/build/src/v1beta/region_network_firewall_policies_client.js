...
exports.RegionNetworkFirewallPoliciesClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/region_network_firewall_policies_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./region_network_firewall_policies_client_config.json");
...
class RegionNetworkFirewallPoliciesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.RegionNetworkFirewallPolicies', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.regionNetworkFirewallPoliciesStub) {
            return this.regionNetworkFirewallPoliciesStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.RegionNetworkFirewallPolicies.
        this.regionNetworkFirewallPoliciesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.RegionNetworkFirewallPolicies') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.RegionNetworkFirewallPolicies, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const regionNetworkFirewallPoliciesStubMethods = ['addAssociation', 'addRule', 'cloneRules', 'delete', 'get', 'getAssociation', 'getEffectiveFirewalls', 'getIamPolicy', 'getRule', 'insert', 'list', 'patch', 'patchAssociation', 'patchRule', 'removeAssociation', 'removeRule', 'setIamPolicy', 'testIamPermissions'];
        for (const methodName of regionNetworkFirewallPoliciesStubMethods) {
            const callPromise = this.regionNetworkFirewallPoliciesStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    cloneRules(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    patchAssociation(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls.patchAssociation(request, options, wrappedCallback)
            ?.then(([response, operation, rawResponse]) => {
            return [
                { latestResponse: response, done: false, name: response.id, metadata: null, result: {} },
                operation,
     ...
     */
    close() {
        if (this.regionNetworkFirewallPoliciesStub && !this._terminated) {
            return this.regionNetworkFirewallPoliciesStub.then(stub => {
...
//# sourceMappingURL=region_network_firewall_policies_client.js.map