...
exports.SecurityPoliciesClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/security_policies_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./security_policies_client_config.json");
...
class SecurityPoliciesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.SecurityPolicies', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.securityPoliciesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.SecurityPolicies') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.SecurityPolicies, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const securityPoliciesStubMethods = ['addRule', 'aggregatedList', 'delete', 'get', 'getRule', 'insert', 'list', 'listPreconfiguredExpressionSets', 'patch', 'patchRule', 'removeRule', 'setLabels', 'testIamPermissions'];
        for (const methodName of securityPoliciesStubMethods) {
            const callPromise = this.securityPoliciesStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=security_policies_client.js.map