...
exports.NetworkEdgeSecurityServicesClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/network_edge_security_services_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./network_edge_security_services_client_config.json");
...
class NetworkEdgeSecurityServicesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.NetworkEdgeSecurityServices', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        // google.cloud.compute.v1beta.NetworkEdgeSecurityServices.
        this.networkEdgeSecurityServicesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.NetworkEdgeSecurityServices') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.NetworkEdgeSecurityServices, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const networkEdgeSecurityServicesStubMethods = ['aggregatedList', 'delete', 'get', 'insert', 'patch'];
        for (const methodName of networkEdgeSecurityServicesStubMethods) {
            const callPromise = this.networkEdgeSecurityServicesStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=network_edge_security_services_client.js.map