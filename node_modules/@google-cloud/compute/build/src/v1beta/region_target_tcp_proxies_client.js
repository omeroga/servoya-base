...
exports.RegionTargetTcpProxiesClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/region_target_tcp_proxies_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./region_target_tcp_proxies_client_config.json");
...
class RegionTargetTcpProxiesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.RegionTargetTcpProxies', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        // google.cloud.compute.v1beta.RegionTargetTcpProxies.
        this.regionTargetTcpProxiesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.RegionTargetTcpProxies') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.RegionTargetTcpProxies, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const regionTargetTcpProxiesStubMethods = ['delete', 'get', 'insert', 'list', 'testIamPermissions'];
        for (const methodName of regionTargetTcpProxiesStubMethods) {
            const callPromise = this.regionTargetTcpProxiesStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=region_target_tcp_proxies_client.js.map