...
exports.InstantSnapshotsClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/instant_snapshots_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./instant_snapshots_client_config.json");
...
class InstantSnapshotsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.InstantSnapshots', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.instantSnapshotsStub) {
            return this.instantSnapshotsStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.InstantSnapshots.
        this.instantSnapshotsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.InstantSnapshots') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.InstantSnapshots, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const instantSnapshotsStubMethods = ['aggregatedList', 'delete', 'get', 'getIamPolicy', 'insert', 'list', 'setIamPolicy', 'setLabels', 'testIamPermissions'];
        for (const methodName of instantSnapshotsStubMethods) {
            const callPromise = this.instantSnapshotsStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    delete(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] = this._gaxModule.routingHeader.fromParams({
            ...
            'zone': request.zone ?? '',
            'instant_snapshot': request.instantSnapshot ?? '',
        });
     ...
     */
    close() {
        if (this.instantSnapshotsStub && !this._terminated) {
            return this.instantSnapshotsStub.then(stub => {
...
//# sourceMappingURL=instant_snapshots_client.js.map