...
exports.RegionBackendServicesClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/region_backend_services_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./region_backend_services_client_config.json");
...
class RegionBackendServicesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.RegionBackendServices', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.regionBackendServicesStub) {
            return this.regionBackendServicesStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.RegionBackendServices.
        this.regionBackendServicesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.RegionBackendServices') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.RegionBackendServices, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const regionBackendServicesStubMethods = ['delete', 'get', 'getHealth', 'getIamPolicy', 'insert', 'list', 'listUsable', 'patch', 'setIamPolicy', 'setSecurityPolicy', 'testIamPermissions', 'update'];
        for (const methodName of regionBackendServicesStubMethods) {
            const callPromise = this.regionBackendServicesStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=region_backend_services_client.js.map