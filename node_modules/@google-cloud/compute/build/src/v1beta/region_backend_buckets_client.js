...
exports.RegionBackendBucketsClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/region_backend_buckets_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./region_backend_buckets_client_config.json");
...
class RegionBackendBucketsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.RegionBackendBuckets', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.regionBackendBucketsStub) {
            return this.regionBackendBucketsStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.RegionBackendBuckets.
        this.regionBackendBucketsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.RegionBackendBuckets') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.RegionBackendBuckets, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const regionBackendBucketsStubMethods = ['delete', 'get', 'getIamPolicy', 'insert', 'list', 'listUsable', 'patch', 'setIamPolicy', 'testIamPermissions'];
        for (const methodName of regionBackendBucketsStubMethods) {
            const callPromise = this.regionBackendBucketsStub.then(stub => (...args) => {
                if (this._terminated) {
...
exports.RegionBackendBucketsClient = RegionBackendBucketsClient;
//# sourceMappingURL=region_backend_buckets_client.js.map