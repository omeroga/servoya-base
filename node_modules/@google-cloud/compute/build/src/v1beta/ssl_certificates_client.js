...
exports.SslCertificatesClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/ssl_certificates_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./ssl_certificates_client_config.json");
...
class SslCertificatesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.SslCertificates', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        // google.cloud.compute.v1beta.SslCertificates.
        this.sslCertificatesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.SslCertificates') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.SslCertificates, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const sslCertificatesStubMethods = ['aggregatedList', 'delete', 'get', 'insert', 'list', 'testIamPermissions'];
        for (const methodName of sslCertificatesStubMethods) {
            const callPromise = this.sslCertificatesStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    close() {
        if (this.sslCertificatesStub && !this._terminated) {
...
//# sourceMappingURL=ssl_certificates_client.js.map