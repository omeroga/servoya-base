...
exports.MachineImagesClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/machine_images_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./machine_images_client_config.json");
...
class MachineImagesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.MachineImages', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        // google.cloud.compute.v1beta.MachineImages.
        this.machineImagesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.MachineImages') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.MachineImages, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const machineImagesStubMethods = ['delete', 'get', 'getIamPolicy', 'insert', 'list', 'setIamPolicy', 'setLabels', 'testIamPermissions'];
        for (const methodName of machineImagesStubMethods) {
            const callPromise = this.machineImagesStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=machine_images_client.js.map