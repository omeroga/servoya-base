...
exports.RegionHealthCheckServicesClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/region_health_check_services_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./region_health_check_services_client_config.json");
...
class RegionHealthCheckServicesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.RegionHealthCheckServices', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.regionHealthCheckServicesStub) {
            return this.regionHealthCheckServicesStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.RegionHealthCheckServices.
        this.regionHealthCheckServicesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.RegionHealthCheckServices') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.RegionHealthCheckServices, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const regionHealthCheckServicesStubMethods = ['delete', 'get', 'insert', 'list', 'patch', 'testIamPermissions'];
        for (const methodName of regionHealthCheckServicesStubMethods) {
            const callPromise = this.regionHealthCheckServicesStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    close() {
        if (this.regionHealthCheckServicesStub && !this._terminated) {
            return this.regionHealthCheckServicesStub.then(stub => {
...
//# sourceMappingURL=region_health_check_services_client.js.map