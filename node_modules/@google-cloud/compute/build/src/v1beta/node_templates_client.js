...
exports.NodeTemplatesClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/node_templates_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./node_templates_client_config.json");
...
class NodeTemplatesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.NodeTemplates', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.nodeTemplatesStub) {
            return this.nodeTemplatesStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.NodeTemplates.
        this.nodeTemplatesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.NodeTemplates') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.NodeTemplates, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const nodeTemplatesStubMethods = ['aggregatedList', 'delete', 'get', 'getIamPolicy', 'insert', 'list', 'setIamPolicy', 'testIamPermissions'];
        for (const methodName of nodeTemplatesStubMethods) {
            const callPromise = this.nodeTemplatesStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    delete(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] = this._gaxModule.routingHeader.fromParams({
            ...
            'node_template': request.nodeTemplate ?? '',
        });
...
//# sourceMappingURL=node_templates_client.js.map