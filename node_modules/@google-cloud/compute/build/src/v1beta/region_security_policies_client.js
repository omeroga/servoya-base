...
exports.RegionSecurityPoliciesClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/region_security_policies_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./region_security_policies_client_config.json");
...
class RegionSecurityPoliciesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.RegionSecurityPolicies', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.regionSecurityPoliciesStub) {
            return this.regionSecurityPoliciesStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.RegionSecurityPolicies.
        this.regionSecurityPoliciesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.RegionSecurityPolicies') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.RegionSecurityPolicies, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const regionSecurityPoliciesStubMethods = ['addRule', 'delete', 'get', 'getRule', 'insert', 'list', 'patch', 'patchRule', 'removeRule', 'setLabels'];
        for (const methodName of regionSecurityPoliciesStubMethods) {
            const callPromise = this.regionSecurityPoliciesStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=region_security_policies_client.js.map