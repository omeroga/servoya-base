...
exports.RegionDiskTypesClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/region_disk_types_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./region_disk_types_client_config.json");
...
class RegionDiskTypesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.RegionDiskTypes', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        // google.cloud.compute.v1beta.RegionDiskTypes.
        this.regionDiskTypesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.RegionDiskTypes') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.RegionDiskTypes, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const regionDiskTypesStubMethods = ['get', 'list'];
        for (const methodName of regionDiskTypesStubMethods) {
            const callPromise = this.regionDiskTypesStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=region_disk_types_client.js.map