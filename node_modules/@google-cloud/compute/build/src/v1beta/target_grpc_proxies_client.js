...
exports.TargetGrpcProxiesClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/target_grpc_proxies_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./target_grpc_proxies_client_config.json");
...
class TargetGrpcProxiesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.TargetGrpcProxies', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.targetGrpcProxiesStub) {
            return this.targetGrpcProxiesStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.TargetGrpcProxies.
        this.targetGrpcProxiesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.TargetGrpcProxies') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.TargetGrpcProxies, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const targetGrpcProxiesStubMethods = ['delete', 'get', 'insert', 'list', 'patch', 'testIamPermissions'];
        for (const methodName of targetGrpcProxiesStubMethods) {
            const callPromise = this.targetGrpcProxiesStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=target_grpc_proxies_client.js.map