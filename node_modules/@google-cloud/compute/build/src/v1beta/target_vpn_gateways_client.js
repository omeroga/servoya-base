...
exports.TargetVpnGatewaysClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/target_vpn_gateways_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./target_vpn_gateways_client_config.json");
...
class TargetVpnGatewaysClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.TargetVpnGateways', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        // google.cloud.compute.v1beta.TargetVpnGateways.
        this.targetVpnGatewaysStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.TargetVpnGateways') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.TargetVpnGateways, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const targetVpnGatewaysStubMethods = ['aggregatedList', 'delete', 'get', 'insert', 'list', 'setLabels', 'testIamPermissions'];
        for (const methodName of targetVpnGatewaysStubMethods) {
            const callPromise = this.targetVpnGatewaysStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=target_vpn_gateways_client.js.map