...
exports.RegionCompositeHealthChecksClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/region_composite_health_checks_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./region_composite_health_checks_client_config.json");
...
class RegionCompositeHealthChecksClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.RegionCompositeHealthChecks', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.regionCompositeHealthChecksStub) {
            return this.regionCompositeHealthChecksStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.RegionCompositeHealthChecks.
        this.regionCompositeHealthChecksStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.RegionCompositeHealthChecks') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.RegionCompositeHealthChecks, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const regionCompositeHealthChecksStubMethods = ['aggregatedList', 'delete', 'get', 'insert', 'list', 'patch', 'testIamPermissions'];
        for (const methodName of regionCompositeHealthChecksStubMethods) {
            const callPromise = this.regionCompositeHealthChecksStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    close() {
        if (this.regionCompositeHealthChecksStub && !this._terminated) {
            return this.regionCompositeHealthChecksStub.then(stub => {
...
exports.RegionCompositeHealthChecksClient = RegionCompositeHealthChecksClient;
//# sourceMappingURL=region_composite_health_checks_client.js.map