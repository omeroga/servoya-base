...
exports.ReservationsClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/reservations_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./reservations_client_config.json");
...
class ReservationsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.Reservations', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.reservationsStub) {
            return this.reservationsStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.Reservations.
        this.reservationsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.Reservations') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.Reservations, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const reservationsStubMethods = ['aggregatedList', 'delete', 'get', 'getIamPolicy', 'insert', 'list', 'performMaintenance', 'resize', 'setIamPolicy', 'testIamPermissions', 'update'];
        for (const methodName of reservationsStubMethods) {
            const callPromise = this.reservationsStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=reservations_client.js.map