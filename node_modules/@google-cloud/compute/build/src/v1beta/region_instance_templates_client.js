...
exports.RegionInstanceTemplatesClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/region_instance_templates_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./region_instance_templates_client_config.json");
...
class RegionInstanceTemplatesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.RegionInstanceTemplates', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.regionInstanceTemplatesStub) {
            return this.regionInstanceTemplatesStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.RegionInstanceTemplates.
        this.regionInstanceTemplatesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.RegionInstanceTemplates') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.RegionInstanceTemplates, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const regionInstanceTemplatesStubMethods = ['delete', 'get', 'insert', 'list'];
        for (const methodName of regionInstanceTemplatesStubMethods) {
            const callPromise = this.regionInstanceTemplatesStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    close() {
        if (this.regionInstanceTemplatesStub && !this._terminated) {
            return this.regionInstanceTemplatesStub.then(stub => {
...
//# sourceMappingURL=region_instance_templates_client.js.map