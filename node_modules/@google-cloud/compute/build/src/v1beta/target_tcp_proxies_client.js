...
exports.TargetTcpProxiesClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/target_tcp_proxies_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./target_tcp_proxies_client_config.json");
...
class TargetTcpProxiesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.TargetTcpProxies', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.targetTcpProxiesStub) {
            return this.targetTcpProxiesStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.TargetTcpProxies.
        this.targetTcpProxiesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.TargetTcpProxies') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.TargetTcpProxies, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const targetTcpProxiesStubMethods = ['aggregatedList', 'delete', 'get', 'insert', 'list', 'setBackendService', 'setProxyHeader', 'testIamPermissions'];
        for (const methodName of targetTcpProxiesStubMethods) {
            const callPromise = this.targetTcpProxiesStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=target_tcp_proxies_client.js.map