...
exports.PacketMirroringsClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/packet_mirrorings_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./packet_mirrorings_client_config.json");
...
class PacketMirroringsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.PacketMirrorings', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.packetMirroringsStub) {
            return this.packetMirroringsStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1beta.PacketMirrorings.
        this.packetMirroringsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.PacketMirrorings') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.PacketMirrorings, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const packetMirroringsStubMethods = ['aggregatedList', 'delete', 'get', 'insert', 'list', 'patch', 'testIamPermissions'];
        for (const methodName of packetMirroringsStubMethods) {
            const callPromise = this.packetMirroringsStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=packet_mirrorings_client.js.map