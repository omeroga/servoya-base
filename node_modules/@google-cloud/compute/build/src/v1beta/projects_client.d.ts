...
export declare class ProjectsClient {
     ...
     * @example <caption>include:samples/generated/v1beta/projects.disable_xpn_host.js</caption>
     * region_tag:compute_v1beta_generated_Projects_DisableXpnHost_async
     */
    disableXpnHost(request?: protos.google.cloud.compute.v1beta.IDisableXpnHostProjectRequest, options?: CallOptions): Promise<[
     ...
     * @param {string} request.project
     *   Project ID for this request.
     * @param {google.cloud.compute.v1beta.ProjectsDisableXpnResourceRequest} request.projectsDisableXpnResourceRequestResource
     ...
     *   and might get backwards-incompatible changes at any time.
     *   `.promise()` is not supported yet.
     * @example <caption>include:samples/generated/v1beta/projects.disable_xpn_resource.js</caption>
     * region_tag:compute_v1beta_generated_Projects_DisableXpnResource_async
     */
    disableXpnResource(request?: protos.google.cloud.compute.v1beta.IDisableXpnResourceProjectRequest, options?: CallOptions): Promise<[
        LROperation<protos.google.cloud.compute.v1beta.IOperation, null>,
        protos.google.cloud.compute.v1beta.IOperation | undefined,
        {} | undefined
    ]>;
     ...
     *   and might get backwards-incompatible changes at any time.
     *   `.promise()` is not supported yet.
     * @example <caption>include:samples/generated/v1beta/projects.enable_xpn_host.js</caption>
     * region_tag:compute_v1beta_generated_Projects_EnableXpnHost_async
     */
    enableXpnHost(request?: protos.google.cloud.compute.v1beta.IEnableXpnHostProjectRequest, options?: CallOptions): Promise<[
        LROperation<protos.google.cloud.compute.v1beta.IOperation, null>,
        protos.google.cloud.compute.v1beta.IOperation | undefined,
        {} | undefined
    ]>;
     ...
     * @param {string} request.project
     *   Project ID for this request.
     * @param {google.cloud.compute.v1beta.ProjectsEnableXpnResourceRequest} request.projectsEnableXpnResourceRequestResource
     *   The body resource for this request
     * @param {string} request.requestId
     *   An optional request ID to identify requests. Specify a unique request ID so
     *   that if you must retry your request, the server will know to ignore the
     ...
     *   and might get backwards-incompatible changes at any time.
     *   `.promise()` is not supported yet.
     * @example <caption>include:samples/generated/v1beta/projects.enable_xpn_resource.js</caption>
     * region_tag:compute_v1beta_generated_Projects_EnableXpnResource_async
     */
    enableXpnResource(request?: protos.google.cloud.compute.v1beta.IEnableXpnResourceProjectRequest, options?: CallOptions): Promise<[
        LROperation<protos.google.cloud.compute.v1beta.IOperation, null>,
        protos.google.cloud.compute.v1beta.IOperation | undefined,
        {} | undefined
    ]>;
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     *   The first element of the array is an object representing {@link protos.google.cloud.compute.v1beta.Project|Project}.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1beta/projects.get.js</caption>
     * region_tag:compute_v1beta_generated_Projects_Get_async
     */
    get(request?: protos.google.cloud.compute.v1beta.IGetProjectRequest, options?: CallOptions): Promise<[
        protos.google.cloud.compute.v1beta.IProject,
        protos.google.cloud.compute.v1beta.IGetProjectRequest | undefined,
        {} | undefined
    ]>;
     ...
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1beta/projects.get_xpn_host.js</caption>
     * region_tag:compute_v1beta_generated_Projects_GetXpnHost_async
     */
    getXpnHost(request?: protos.google.cloud.compute.v1beta.IGetXpnHostProjectRequest, options?: CallOptions): Promise<[
        protos.google.cloud.compute.v1beta.IProject,
        protos.google.cloud.compute.v1beta.IGetXpnHostProjectRequest | undefined,
        {} | undefined
    ]>;
     ...
     * @param {Object} request
     *   The request object that will be sent.
     * @param {google.cloud.compute.v1beta.DiskMoveRequest} request.diskMoveRequestResource
     *   The body resource for this request
     * @param {string} request.project
     *   Project ID for this request.
     * @param {string} request.requestId
     ...
     *   and might get backwards-incompatible changes at any time.
     *   `.promise()` is not supported yet.
     * @example <caption>include:samples/generated/v1beta/projects.move_disk.js</caption>
     * region_tag:compute_v1beta_generated_Projects_MoveDisk_async
     */
    moveDisk(request?: protos.google.cloud.compute.v1beta.IMoveDiskProjectRequest, options?: CallOptions): Promise<[
        LROperation<protos.google.cloud.compute.v1beta.IOperation, null>,
        protos.google.cloud.compute.v1beta.IOperation | undefined,
        {} | undefined
    ]>;
     ...
     * @param {Object} request
     *   The request object that will be sent.
     * @param {google.cloud.compute.v1beta.InstanceMoveRequest} request.instanceMoveRequestResource
     *   The body resource for this request
     * @param {string} request.project
     *   Project ID for this request.
     * @param {string} request.requestId
     ...
     *   and might get backwards-incompatible changes at any time.
     *   `.promise()` is not supported yet.
     * @example <caption>include:samples/generated/v1beta/projects.move_instance.js</caption>
     * region_tag:compute_v1beta_generated_Projects_MoveInstance_async
     */
    moveInstance(request?: protos.google.cloud.compute.v1beta.IMoveInstanceProjectRequest, options?: CallOptions): Promise<[
        LROperation<protos.google.cloud.compute.v1beta.IOperation, null>,
        protos.google.cloud.compute.v1beta.IOperation | undefined,
        {} | undefined
    ]>;
     ...
     * @param {string} request.project
     *   Project ID for this request.
     * @param {google.cloud.compute.v1beta.ProjectsSetCloudArmorTierRequest} request.projectsSetCloudArmorTierRequestResource
     *   The body resource for this request
     * @param {string} request.requestId
     *   An optional request ID to identify requests. Specify a unique request ID so
     *   that if you must retry your request, the server will know to ignore the
     ...
     *   and might get backwards-incompatible changes at any time.
     *   `.promise()` is not supported yet.
     * @example <caption>include:samples/generated/v1beta/projects.set_cloud_armor_tier.js</caption>
     * region_tag:compute_v1beta_generated_Projects_SetCloudArmorTier_async
     */
    setCloudArmorTier(request?: protos.google.cloud.compute.v1beta.ISetCloudArmorTierProjectRequest, options?: CallOptions): Promise<[
        LROperation<protos.google.cloud.compute.v1beta.IOperation, null>,
        protos.google.cloud.compute.v1beta.IOperation | undefined,
        {} | undefined
    ]>;
     ...
     *   and might get backwards-incompatible changes at any time.
     *   `.promise()` is not supported yet.
     * @example <caption>include:samples/generated/v1beta/projects.set_common_instance_metadata.js</caption>
     * region_tag:compute_v1beta_generated_Projects_SetCommonInstanceMetadata_async
     */
    setCommonInstanceMetadata(request?: protos.google.cloud.compute.v1beta.ISetCommonInstanceMetadataProjectRequest, options?: CallOptions): Promise<[
        LROperation<protos.google.cloud.compute.v1beta.IOperation, null>,
        protos.google.cloud.compute.v1beta.IOperation | undefined,
        {} | undefined
    ]>;
     ...
     * @param {string} request.project
     *   Project ID for this request.
     * @param {google.cloud.compute.v1beta.ProjectsSetDefaultNetworkTierRequest} request.projectsSetDefaultNetworkTierRequestResource
     *   The body resource for this request
     * @param {string} request.requestId
     *   An optional request ID to identify requests. Specify a unique request ID so
     *   that if you must retry your request, the server will know to ignore the
     ...
     *   and might get backwards-incompatible changes at any time.
     *   `.promise()` is not supported yet.
     * @example <caption>include:samples/generated/v1beta/projects.set_default_network_tier.js</caption>
     * region_tag:compute_v1beta_generated_Projects_SetDefaultNetworkTier_async
     */
    setDefaultNetworkTier(request?: protos.google.cloud.compute.v1beta.ISetDefaultNetworkTierProjectRequest, options?: CallOptions): Promise<[
        LROperation<protos.google.cloud.compute.v1beta.IOperation, null>,
        protos.google.cloud.compute.v1beta.IOperation | undefined,
        {} | undefined
    ]>;
     ...
     * @param {string} request.project
     *   Project ID for this request.
     * @param {google.cloud.compute.v1beta.ProjectsSetManagedProtectionTierRequest} request.projectsSetManagedProtectionTierRequestResource
     *   The body resource for this request
     * @param {string} request.requestId
     *   An optional request ID to identify requests. Specify a unique request ID so
     *   that if you must retry your request, the server will know to ignore the
     ...
     *   and might get backwards-incompatible changes at any time.
     *   `.promise()` is not supported yet.
     * @example <caption>include:samples/generated/v1beta/projects.set_managed_protection_tier.js</caption>
     * region_tag:compute_v1beta_generated_Projects_SetManagedProtectionTier_async
     */
    setManagedProtectionTier(request?: protos.google.cloud.compute.v1beta.ISetManagedProtectionTierProjectRequest, options?: CallOptions): Promise<[
        LROperation<protos.google.cloud.compute.v1beta.IOperation, null>,
        protos.google.cloud.compute.v1beta.IOperation | undefined,
        {} | undefined
    ]>;
     ...
     *   a valid UUID with the exception that zero UUID is not supported
     *   (00000000-0000-0000-0000-000000000000).
     * @param {google.cloud.compute.v1beta.UsageExportLocation} request.usageExportLocationResource
     *   The body resource for this request
     * @param {object} [options]
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     ...
     *   and might get backwards-incompatible changes at any time.
     *   `.promise()` is not supported yet.
     * @example <caption>include:samples/generated/v1beta/projects.set_usage_export_bucket.js</caption>
     * region_tag:compute_v1beta_generated_Projects_SetUsageExportBucket_async
     */
    setUsageExportBucket(request?: protos.google.cloud.compute.v1beta.ISetUsageExportBucketProjectRequest, options?: CallOptions): Promise<[
        LROperation<protos.google.cloud.compute.v1beta.IOperation, null>,
        protos.google.cloud.compute.v1beta.IOperation | undefined,
        {} | undefined
    ]>;
    ...
    *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
    * @returns {Promise} - The promise which resolves to an array.
    *   The first element of the array is Array of {@link protos.google.cloud.compute.v1beta.XpnResourceId|XpnResourceId}.
    ...
    *   for more details and examples.
    */
    getXpnResources(request?: protos.google.cloud.compute.v1beta.IGetXpnResourcesProjectsRequest, options?: CallOptions): Promise<[
        protos.google.cloud.compute.v1beta.IXpnResourceId[],
        protos.google.cloud.compute.v1beta.IGetXpnResourcesProjectsRequest | null,
        protos.google.cloud.compute.v1beta.IProjectsGetXpnResources
    ]>;
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Stream}
     *   An object stream which emits an object representing {@link protos.google.cloud.compute.v1beta.XpnResourceId|XpnResourceId} on 'data' event.
     *   The client library will perform auto-pagination by default: it will call the API as many
     ...
     *   {@link protos.google.cloud.compute.v1beta.XpnResourceId|XpnResourceId}. The API will be called under the hood as needed, once per the page,
     *   so you can stop the iteration when you don't need more results.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1beta/projects.get_xpn_resources.js</caption>
     * region_tag:compute_v1beta_generated_Projects_GetXpnResources_async
     */
    ...
    * @param {string} request.project
    *   Project ID for this request.
    * @param {google.cloud.compute.v1beta.ProjectsListXpnHostsRequest} request.projectsListXpnHostsRequestResource
    *   The body resource for this request
    * @param {boolean} request.returnPartialSuccess
    *   Opt-in for partial success behavior which provides partial results in case
    *   of failure. The default value is false.
    ...
    *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
    * @returns {Promise} - The promise which resolves to an array.
    *   The first element of the array is Array of {@link protos.google.cloud.compute.v1beta.Project|Project}.
    *   The client library will perform auto-pagination by default: it will call the API as many
    *   times as needed and will merge results from all the pages into this array.
    *   Note that it can affect your quota.
    ...
    *   for more details and examples.
    */
    listXpnHosts(request?: protos.google.cloud.compute.v1beta.IListXpnHostsProjectsRequest, options?: CallOptions): Promise<[
        protos.google.cloud.compute.v1beta.IProject[],
        protos.google.cloud.compute.v1beta.IListXpnHostsProjectsRequest | null,
        protos.google.cloud.compute.v1beta.IXpnHostList
    ]>;
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Stream}
     *   An object stream which emits an object representing {@link protos.google.cloud.compute.v1beta.Project|Project} on 'data' event.
     *   The client library will perform auto-pagination by default: it will call the API as many
     *   times as needed. Note that it can affect your quota.
     *   We recommend using `listXpnHostsAsync()`
     *   method described below for async iteration which you can stop as needed.
     ...
     *   An iterable Object that allows {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols | async iteration }.
     *   When you iterate the returned iterable, each element will be an object representing
     *   {@link protos.google.cloud.compute.v1beta.Project|Project}. The API will be called under the hood as needed, once per the page,
     *   so you can stop the iteration when you don't need more results.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1beta/projects.list_xpn_hosts.js</caption>
     * region_tag:compute_v1beta_generated_Projects_ListXpnHosts_async
     */
