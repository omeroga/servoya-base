...
exports.FirewallPoliciesClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/firewall_policies_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./firewall_policies_client_config.json");
...
class FirewallPoliciesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.FirewallPolicies', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.firewallPoliciesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.FirewallPolicies') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.FirewallPolicies, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const firewallPoliciesStubMethods = ['addAssociation', 'addPacketMirroringRule', 'addRule', 'cloneRules', 'delete', 'get', 'getAssociation', 'getIamPolicy', 'getPacketMirroringRule', 'getRule', 'insert', 'list', 'listAssociations', 'move', 'patch', 'patchPacketMirroringRule', 'patchRule', 'removeAssociation', 'removePacketMirroringRule', 'removeRule', 'setIamPolicy', 'testIamPermissions'];
        for (const methodName of firewallPoliciesStubMethods) {
            const callPromise = this.firewallPoliciesStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    addPacketMirroringRule(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    getPacketMirroringRule(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    patchPacketMirroringRule(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    removePacketMirroringRule(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    close() {
        if (this.firewallPoliciesStub && !this._terminated) {
...
//# sourceMappingURL=firewall_policies_client.js.map