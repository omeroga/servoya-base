...
exports.NetworkFirewallPoliciesClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/network_firewall_policies_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./network_firewall_policies_client_config.json");
...
class NetworkFirewallPoliciesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.NetworkFirewallPolicies', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.networkFirewallPoliciesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.NetworkFirewallPolicies') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.NetworkFirewallPolicies, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of networkFirewallPoliciesStubMethods) {
            const callPromise = this.networkFirewallPoliciesStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=network_firewall_policies_client.js.map