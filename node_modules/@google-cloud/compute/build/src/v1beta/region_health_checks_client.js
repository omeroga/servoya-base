...
exports.RegionHealthChecksClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/region_health_checks_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./region_health_checks_client_config.json");
...
class RegionHealthChecksClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.RegionHealthChecks', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        // google.cloud.compute.v1beta.RegionHealthChecks.
        this.regionHealthChecksStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.RegionHealthChecks') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.RegionHealthChecks, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const regionHealthChecksStubMethods = ['delete', 'get', 'insert', 'list', 'patch', 'testIamPermissions', 'update'];
        for (const methodName of regionHealthChecksStubMethods) {
            const callPromise = this.regionHealthChecksStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    close() {
        if (this.regionHealthChecksStub && !this._terminated) {
...
//# sourceMappingURL=region_health_checks_client.js.map